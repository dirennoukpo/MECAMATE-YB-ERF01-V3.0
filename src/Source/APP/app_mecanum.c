...
// X-axis speed (forward +, backward -: ±1000), Y-axis speed (left +, right -: ±1000), rotation speed (left +, right -: ±5000)
// X3 PLUS X-axis speed (forward +, backward -: ±700), Y-axis speed (left +, right -: ±700), rotation speed (left +, right -: ±3200)
...
// Compute the current deviation from the yaw angle, to correct the car's motion direction.
...
// Control the motion state of the mecanum wheel car.
// Speed control: speed=0~1000.
// Yaw angle motion adjustment: adjust=1 enabled, =0 not enabled.
