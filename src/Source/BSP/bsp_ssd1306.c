...
{
    /* A little delay */
    // volatile: otherwise GCC completely removes this delay loop (body with no
    // side effect, non-volatile counter) and the first I2C command is sent with
    // no delay after the panel is powered up. ARMCC used to emit it.
